...
const BestSellers = () => {
  ...
  const fetchBestSellers = async () => {
    try {
      ...
      // In real app, you'd have a 'views' or 'purchases' field
      const allProducts = [
        ...(dressesRes.data.dresses?.map(d => ({ ...d, type: 'dress' })) || []),
        ...(jewelleryRes.data.jewellery?.map(j => ({ ...j, type: 'jewellery' })) || [])
      ];

      // Sort by discount (as a proxy for popularity) and take first 10
  ...
  styleSheet.textContent = `
    ...
    .bestseller-card:hover .card-overlay {
      opacity: 1;
    }
    
    .bestseller-card:hover .view-btn {
          ...
          return (
            ...
            >
               ...
               className='text-decoration-none'
                    to={`/${product.type}/${product._id}`} 
                  
                  >
              <div style={styles.imageContainer}>
                <img 
                  src={product.images?.cover || product.image || 'https://via.placeholder.com/280x300'} 
                  alt={product.name}
                  style={styles.image}
              ...
              <div style={styles.content}>
                ...
                <p style={styles.type}>
                  ...
                  {product.type === 'dress' ? 'Dress' : 'Jewellery'}
                </p>
